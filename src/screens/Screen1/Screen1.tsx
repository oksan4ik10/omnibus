            ...
            <main className={style.main}>
                ...
                <div className={style.main__info + " " + style.info}>
                    ...
                    <div className={style.info__text}>
                        ...
                        <p>Карьера может сложиться интересно в&nbsp;любом случае! Мы опросили сотрудников 9 компаний и выяснили, что все ограничения только у нас в&nbsp;голове. Ты можешь работать по&nbsp;специальности или развиваться в&nbsp;любом другом интересном тебе направлении. </p>
